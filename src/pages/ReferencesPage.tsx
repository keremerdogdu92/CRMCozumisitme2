...
import type { NewReferenceForm, ReferenceRow } from '../features/references/types';
...
export default function ReferencesPage() {
  ...
  if (isLoading) {
    return <div className="p-8 text-sm text-slate-500">Referanslar yükleniyor...</div>;
  }
  ...
  return (
    <div className="p-8 space-y-6">
        ...
        <ReferenceNewFormCard
          ...
          onSubmit={() =>
            createMutation.mutate({
              ...
              lastMeetAt: formState.lastMeetAt,
      ...
      {/* Detail drawer */}a// src/pages/ReferencesPage.tsx
// References page: list, inline create form and detail drawer orchestration.
